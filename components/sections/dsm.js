  ...
  <Section>
    <CardsLayout>
      ...
      <Card title="Library version control" image="dsm/library-version-control">
        Changes sync to the whole team, and designers can switch to latest
        version or roll back changes at any time.
      </Card>
      ...
      <Card title="Public microsite" image="dsm/custom-microsite">
        InVision’s Design System Manager guarantees instant access to your
